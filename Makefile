...
FLAGS = -march=native -static -std=c++17 -g -O3 -I3rd/CLI11/include #-fopenmp # $(DEBUG)
LIBS = -lstdc++ -lstdc++fs

.DEFAULT_GOAL := icecuber
...
icecuber: src/main.cpp $(OBJ_PATH) $(HEAD_PATH) headers/tasks.hpp
	g++ src/main.cpp $(OBJ_PATH) $(FLAGS) $(LIBS) -o icecuber -I headers
